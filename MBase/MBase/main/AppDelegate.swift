...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification) {
        ...
        //设置数据请求的实体结构
        fetchRequest.entity = NSEntityDescription.entity(forEntityName: "UserInfo",
        ...
        do{
            userInfos = try managedObjectContext.fetch(fetchRequest) as! [UserInfo];
        }catch{
        ...
        if userInfos.count > 0 {
            ...
            userInfo = NSEntityDescription.insertNewObject(forEntityName: "UserInfo", into: self.managedObjectContext) as! UserInfo;
        }
...
//        }
    ...
    lazy var applicationDocumentsDirectory: URL = {
        ...
        return appSupportURL.appendingPathComponent("com.pop.MBase")
    }()
    
    lazy var managedObjectModel: NSManagedObjectModel = {
        // The managed object model for the application. This property is not optional. It is a fatal error for the application not to be able to find and load its model.
        let modelURL = Bundle.main.url(forResource: "MBase", withExtension: "momd")!
